...
namespace BasicMVC4.Infrastructure.Extensions
{
    public static class HtmlHelperExtensions
    {
        ...
        {
            var accountId = ConfigurationManager.AppSettings["BasicMVC4.GoogleAnalyticsAccount"];
        ...
        {
            var accountId = ConfigurationManager.AppSettings["BasicMVC4.FacebookInsightAccount"];
